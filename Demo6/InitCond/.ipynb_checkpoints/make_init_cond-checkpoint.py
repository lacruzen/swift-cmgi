...
# Save profile data
target_spin.save("cmgi_target_profile.hdf5")
impactor_spin.save("cmgi_impactor_profile.hdf5")
...
target.save(
    "cmgi_target_%s.hdf5" % N_label,
    boxsize=10 * R_E,
    file_to_SI=file_to_SI,
    do_entropies=True,
)
impactor.save(
    "cmgi_impactor_%s.hdf5" % N_label,
    boxsize=10 * R_E,
    file_to_SI=file_to_SI,
    do_entropies=True,
)