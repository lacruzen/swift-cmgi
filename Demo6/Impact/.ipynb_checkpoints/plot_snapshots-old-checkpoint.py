...
if __name__ == "__main__":
    print()
    print("CMGI Impact Simulation Plot")
    print("=" * 50)
    ...
    for snapshot_id in range(28):
        ...
        try:
            ...
            A2_pos, A1_mat_id, A2_vel = load_snapshot(
                "snapshots/cmgi_impact_%s_%04d.hdf5" % (N_label, snapshot_id)
            )
            ...
            # Save the figure
            save_path = "cmgi_plots/cmgi_impact_%s_%04d.png" % (N_label, snapshot_id)
            ...
            print(f"  ✗ Snapshot file not found: snapshots/cmgi_impact_{N_label}_{snapshot_id:04d}.hdf5")
